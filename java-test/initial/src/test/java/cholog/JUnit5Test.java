            ...
            class LocalObject {
                ...
                public boolean equals(Object obj) {
                    if (obj instanceof LocalObject) {
                        return this.value == ((LocalObject) obj).value;
                    }
                    return false;
                }
            }
...
//            }
            Assertions.assertEquals(expected, actual, "두 값이 일치하지 않습니다.");
        }
...
//            throw new RuntimeException("예외가 발생하지 않았습니다.");
            Assertions.assertThrows(IllegalCallerException.class, this::causeException);
        }
    ...
    class ParameterizedAnnotationTest {
        ...
        @ParameterizedTest
        @ValueSource(ints = 1)
        @DisplayName("ValueSource 애노테이션을 붙여 정수 매개변수를 한 번 입력받는다1")
         ...
         */
        @DisplayName("ValueSource 애노테이션을 붙여 정수 매개변수를 여러 번 입력받는다2")
        @ParameterizedTest
        @ValueSource(ints = {1, 2, 3, 4})
        void ValueSource_애노테이션을_붙여_정수_매개변수를_여러_번_입력받는다1(int value) {
...
//            assertTrue(value > 0 && value < 10);
         ...
         */
        @DisplayName("ValueSource 애노테이션을 붙여 문자열 매개변수를 여러 번 입력받는다3")
        @ParameterizedTest
        @ValueSource(strings = {"a", "b", "c"})
        void ValueSource_애노테이션을_붙여_문자열_매개변수를_여러_번_입력받는다2(String value) {
        ...
        private static Stream<Arguments> methodSourcesTestArguments() {
            return Stream.of(Arguments.arguments(new Object(), new Object(), new Object()));
        }
